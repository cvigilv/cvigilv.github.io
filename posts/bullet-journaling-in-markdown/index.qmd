...
date: "2025.02.05 09:02"
categories: [pkm, neovim]
---
...
, `#journal` (to track what I'm doing; here is where I use the aformentioned Markdown bullet
...
means this where not properly taken care of (either by doing this, defering, carrying over, or
simply removing)
